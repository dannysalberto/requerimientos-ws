...
@Entity
@Table(name="v_actividadobra",schema="modificacion")
public class V_ActividadObraModificacion {
	...
	@ManyToOne
	@JsonBackReference
	@JoinColumn(name="obra_id") //obramodificacion_id
    ...
    @Column(name="valortotalactividadaiu")
	...
	@Column(name="newfechainicio")
	private Date newfechainicio;
	
	@Column(name="newfechafin")
    ...
    @Column(name="newvalorunitario")
    private BigDecimal newvalorunitario = new BigDecimal(0);
    
    @Column(name="newvalortotalactividadaiu")
	...
	public String toString() {
		return "V_ActividadObraModificacion [id=" + id + ", obraModificacion=" + obraModificacion + ", oidactiviobra="
